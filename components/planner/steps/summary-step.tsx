      ...
      <div className="text-center space-y-6">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground max-w-md mx-auto">
            Ihre Solaranlagen-Planung wurde erfolgreich übermittelt. Wir werden uns in Kürze bei Ihnen melden.
          </p>
        </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div>
                <span className="font-medium">Stromverbrauch:</span> {formData.currentConsumption} kWh/Jahr
              </div>
              <div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <span className="font-medium">Adresse:</span> {formData.street}, {formData.zipCode} {formData.city}
              </div>
            </div>
          </div>
        </CardContent>
